...
export { KeyError, OSError, OverflowError, ValueError } from './errors'
...
export class BaseBoard {
   ...
   * For example,
   * `board.occupied ^ board.piecesMask(chess.KING, board.turn)` can be used
   * to consider X-ray attacks through the king.
