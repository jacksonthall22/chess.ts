...
registerTestCase('PgnTestCase', PgnTestCase, {
  lines: {
    testExporter: 2093,
    testPromoteToMain: 2194,
    testReadGameWithMulticommentMove: 2232,
    testCommentAtEol: 2240,
    testGameStartingComment: 2339,
    testGameStartingVariation: 2349,
    testTreeTraversal: 2389,
    testPromoteDemote: 2420,
    testAddLine: 2701,
    testMainline: 2718,
    testAnnotations: 2843,
    testFloatEmt: 2894,
    testFloatClk: 2907,
    testUtf8Bom: 2962,
  },
